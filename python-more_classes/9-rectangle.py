...
including basic properties, area/perimeter calculations, static comparison,
and a class method to instantiate a square representation.
"""
...
class Rectangle:
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int): The size length for both width and height.
